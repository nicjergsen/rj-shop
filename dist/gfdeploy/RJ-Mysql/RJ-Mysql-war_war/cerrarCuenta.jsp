<%-- 
    Document   : cerrarCuenta
    Created on : 15-jul-2016, 17:39:14
    Author     : xHirasawa
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <!-- Register Box -->
            <div class="col-md-7">
                <form class="signup-page" action="CerrarCuenta.do" method="post">
                    <h2 class="signup-header" >Cerrar Cuenta</h2>

                    <%
                        String mensaje = (String) request.getAttribute("mensaje");
                        boolean bandera = false;
                        if((mensaje == "Cuenta eliminada.") || (mensaje=="El usuario indicado no existe.")){
                            bandera = true;
                        }
                    %>
                    ...
                    <div class="row">    
                        ...
                        <br></br>
                        <button class="btn btn-primary" type="submit">Cerrar Cuenta</button>
