...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row" >
                <div class="col-lg-12" margin:100px>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Listar Comics</li>
                    </ol>
                </div>
            </div>
            <!-- /.row -->
            ...
            <div class="container">
                <%
                List<Comics> lista = (List<Comics>)request.getAttribute("comics");
                ...
                for (Comics c : lista){
                    ...
                    <tr>
                        <td><%=c.getComId()%></td>
                        <td><%=c.getComTitulo()%></td>
                        <td><%=c.getComEditorial()%></td>
                        <td><%=c.getComNombreheroe()%></td>
                        <td><%=c.getComNumerotitulo()%></td>
                        <td><%=c.getComStock()%></td>
                        <td><%=c.getComDescripcion()%></td>
                        <td><%=c.getComPrecio()%></td>
                    </tr>
                    <%
                }
                %>
