...
<body>
        ...
        <div class="row" >
            <div class="col-lg-12" margin:100px>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Eliminar Comic</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    ...
                    <a href="buscarComic.jsp" class="list-group-item">Editar Comic</a>
                     <a href="eliminarComic.jsp" class="list-group-item active">Eliminar Comic</a>
    ...
    <!-- formulario agregar 
                ...
                <!-- === BEGIN CONTENT === -->
                                ...
                                <!-- Register Box -->
                                <div class="col-md-7">
                                    <form class="signup-page"  action="EliminarComic.do" method="post">
                                        <div class="signup-header">
                                            <h2>Eliminar Comic</h2>
                                           
                                        </div>
                                        <label>Codigo</label>
                                        <input class="form-control margin-bottom-20" type="text" name="txtID">
